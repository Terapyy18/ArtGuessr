...
class GameViewModel: ObservableObject {
    ...
    // MARK: - Propriétés dérivées pour la vue
    ...
    var currentArtwork: ArtWork? {
        gameInstance?.currentArtwork
    }
    
    var currentOptions: [ArtWork] {
        gameInstance?.currentOptions ?? []
    }
    ...
    func saveScoreAndRestart(context: ModelContext, finalScore: Int) {
